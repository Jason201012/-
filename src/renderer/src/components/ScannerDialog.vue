  ...
  >
    <div class="scanner-container">
      ...
      <div v-else-if="!hasPermission" class="permission-request">
        ...
        <p>需要摄像头权限才能扫描二维码</p>
        <el-button type="primary" :loading="requesting" @click="requestCamera">
          授权摄像头
        </el-button>
      </div>
      ...
      <div v-else class="scanner-view">
        ...
        <div class="scanner-controls">
          <el-button :disabled="!isScanning" @click="toggleCamera">
            <el-icon><Refresh /></el-icon>
            切换摄像头
          </el-button>
          <el-button :disabled="!isScanning" @click="toggleFlash">
