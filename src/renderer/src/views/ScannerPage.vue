        ...
        <div class="result-content">
          <div v-if="lastResult.type === 'wifi'" class="parsed-result">
            ...
            <div class="result-item">
              ...
              <span class="value">{{ (lastResult.parsedData?.data as WifiParsedData)?.password }}</span>
            </div>
            <div class="result-item">
              <span class="label">加密类型:</span>
              <span class="value">{{ (lastResult.parsedData?.data as WifiParsedData)?.encryption }}</span>
            </div>
          </div>
          
          <div v-else-if="lastResult.type === 'vcard'" class="parsed-result">
            <div class="result-item" v-if="(lastResult.parsedData?.data as VCardParsedData)?.name">
              <span class="label">姓名:</span>
              <span class="value">{{ (lastResult.parsedData?.data as VCardParsedData)?.name }}</span>
            </div>
            <div class="result-item" v-if="(lastResult.parsedData?.data as VCardParsedData)?.phone">
              <span class="label">电话:</span>
              <span class="value">{{ (lastResult.parsedData?.data as VCardParsedData)?.phone }}</span>
            </div>
            <div class="result-item" v-if="(lastResult.parsedData?.data as VCardParsedData)?.email">
              <span class="label">邮箱:</span>
              <span class="value">{{ (lastResult.parsedData?.data as VCardParsedData)?.email }}</span>
            </div>
            <div class="result-item" v-if="(lastResult.parsedData?.data as VCardParsedData)?.organization">
              <span class="label">公司:</span>
              <span class="value">{{ (lastResult.parsedData?.data as VCardParsedData)?.organization }}</span>
            </div>
          </div>
          ...
          <div v-else-if="lastResult.type === 'email'" class="parsed-result">
            ...
            <div class="result-item" v-if="(lastResult.parsedData?.data as EmailParsedData)?.subject">
              <span class="label">主题:</span>
              <span class="value">{{ (lastResult.parsedData?.data as EmailParsedData)?.subject }}</span>
            </div>
          </div>
          ...
          <div v-else-if="lastResult.type === 'phone'" class="parsed-result">
            <div class="result-item">
              ...
              <span class="value">{{ (lastResult.parsedData?.data as PhoneParsedData)?.number }}</span>
            </div>
          </div>
...
import type { VCardParsedData, WifiParsedData, EmailParsedData, PhoneParsedData } from '../types/scanner'
