    ...
    <div class="batch-content">
      ...
      <div v-else class="file-input-area">
        ...
        >
          ...
          <template #tip>
            <div class="el-upload__tip">支持 CSV、Excel、TXT 文件，第一列为二维码内容</div>
          </template>
        </el-upload>
      ...
      <div class="batch-actions">
        <el-button type="primary" :loading="generating" @click="generateBatch">
      ...
      <div v-if="batchItems.length > 0" class="batch-results">
        <div class="results-header">
          ...
          <el-button type="success" :disabled="successCount === 0" @click="exportAll">
