  ...
  <div class="image-scanner-page">
    ...
    <div class="scan-area">
      ...
      <div class="action-buttons">
        <el-button type="primary" :disabled="isScanning" @click="triggerFileInput">
          <el-icon><FolderOpened /></el-icon>
          选择图片
        </el-button>
        <el-button :disabled="isScanning" @click="pasteFromClipboard">
          <el-icon><DocumentCopy /></el-icon>
          从剪贴板粘贴
        </el-button>
        <el-button v-if="previewImage" :disabled="isScanning" @click="clearImage">
      ...
      <el-card class="result-card">
        <div class="result-content">
          ...
          <div v-else-if="scanResult.type === 'vcard'" class="parsed-result">
            <div v-if="scanResult.parsedData?.data?.name" class="result-item">
              <span class="label">姓名:</span>
              <span class="value">{{ scanResult.parsedData?.data?.name }}</span>
            </div>
            <div v-if="scanResult.parsedData?.data?.phone" class="result-item">
              <span class="label">电话:</span>
              <span class="value">{{ scanResult.parsedData?.data?.phone }}</span>
            </div>
            <div v-if="scanResult.parsedData?.data?.email" class="result-item">
